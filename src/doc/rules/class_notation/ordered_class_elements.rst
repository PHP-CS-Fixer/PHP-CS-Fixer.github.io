...
@PER
  Using the :doc:`@PER <./../../ruleSets/PER>` rule set will enable the ``ordered_class_elements`` rule with the config below:

  ``['order' => ['use_trait']]``

@PSR12
  Using the :doc:`@PSR12 <./../../ruleSets/PSR12>` rule set will enable the ``ordered_class_elements`` rule with the config below:

  ``['order' => ['use_trait']]``

@PhpCsFixer
  Using the :doc:`@PhpCsFixer <./../../ruleSets/PhpCsFixer>` rule set will enable the ``ordered_class_elements`` rule with the default config.

@Symfony
  Using the :doc:`@Symfony <./../../ruleSets/Symfony>` rule set will enable the ``ordered_class_elements`` rule with the config below:
