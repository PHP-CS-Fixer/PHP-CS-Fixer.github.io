...
@PhpCsFixer
  Using the :doc:`@PhpCsFixer <./../../ruleSets/PhpCsFixer>` rule set will enable the ``general_phpdoc_tag_rename`` rule with the config below:

  ``['replacements' => ['inheritDocs' => 'inheritDoc']]``

@Symfony
  Using the :doc:`@Symfony <./../../ruleSets/Symfony>` rule set will enable the ``general_phpdoc_tag_rename`` rule with the config below:
